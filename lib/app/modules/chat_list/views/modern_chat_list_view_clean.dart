...
class _ModernChatListViewState extends State<ModernChatListView> {
  ...
  Widget _buildGridView(List<ChatModel> chats) {
    return GridView.builder(
      ...
      itemCount: chats.length,
      itemBuilder: (context, index) => _buildChatGridItem(chats[index]),
    );
  }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      if (chat.unreadCount > 0) _buildUnreadBadge(chat.unreadCount),
                    ],
                  ),
                ],
              ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            _buildAvatar(chat, size: 80, showBadgeOnTop: true),
  ...
  Widget _buildAvatar(ChatModel chat, {required double size, bool showBadgeOnTop = false}) {
    return Stack(
      children: [
        Container(
          width: size,
        ...
        if (showBadgeOnTop && chat.unreadCount > 0)
          Positioned(
            right: -4,
            top: -4,
            child: Container(
